            ...
            <div className=" flex    items-center  w-[70%] h-[90%] mx-auto p-2 shadow-md rounded-lg mt-8 bg-white">
                ...
                <div className="w-[55%] py-16 px-16">
                    ...
                    <p className='text-sm text-gray-500'>
                        ...
                        <Link className="text-blue-500 underline pl-2" to="/signup">
                            Sign Up
                        </Link>
                    </p>
                    <form className="flex flex-col gap-2 my-6">
                        {/* <input type="text" placeholder='Full Name' className='border-transparent border-2 focus:border-blue-500 focus:border-2 focus:outline-none'/> */}
                        <input
                            type="email"
                            placeholder="Email"
